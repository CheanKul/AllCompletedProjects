...
{%>
 <input type="radio" name="l_type" value="LL"
	...
	<input type=radio name=DL id=DL disabled="disabled">DL
	<%} 
	else { %>
	<input type=radio name=LL id=LL disabled="disabled">LL &nbsp;&nbsp;&nbsp;&nbsp; 
...
<table cellspacing=10>
	...
	<tr>
		...
		<td><select name="rtoId">
			<%
				ArrayList arr1 = (ArrayList) request.getAttribute("name");
				ArrayList arr2 = (ArrayList) request.getAttribute("id");

				for (int i = 0; i < arr1.size(); i++) {
			%>
			<option value="<%=arr2.get(i)%>"><%=arr1.get(i)%></option>
